...
## 0.3.10 Beta - pirateflix Is Love - 31 October 2016
...
- Switch to pirateflix API  (https://github.com/pirateflix-official/pirateflix-api)
...
- Fix the pirateflix player when watching trailers.
...
- Start pirateflix minimized with "-m" flag
- 1080p TV Shows are here !
- "Big Picture Mode" will allow you to read pirateflix's texts from your couch
...
- Added in a BitTorrent PeerID specific to pirateflix
...
- Fixed the updater for pirateflix in linux
...
like best at http://discuss.pirateflix.io/t/list-of-pirateflix-time-remote-controls/2044
...
- Move to self-hosted repo, you can now find us at http://git.pirateflix.io
...
- Themes: we give you 3 new themes to check out, and soon you'll be able to
  submit your own.
- HTTP Api: to control pirateflix from another application
- New settings:
