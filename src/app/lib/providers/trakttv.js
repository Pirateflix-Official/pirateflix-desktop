        ...
        syncEpisodes: function() {
            ...
            return this.client.sync.watched({
                ...
                for (var d in shows) { // format for our db
                    var show = shows[d];
                    if (show.appow.ids.imdb && show.appow.ids.tvdb) {
                        for (var s in show.seasons) {
                            var season = show.seasons[s];
                            for (var e in season.episodes) {
                                watchedEpisodes.push({
                                    tvdb_id: show.appow.ids.tvdb.toString(),
                                    imdb_id: show.appow.ids.imdb.toString(),
                        ...
                        console.warn('Cannot sync a show (' + show.appow.title + '), no IMDB/TVDB ids provided by Trakt');
                    }
                }
