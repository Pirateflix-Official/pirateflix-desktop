    ...
    WebTorrentStreamer.prototype = {
        ...
        lookForImages: function (metadatas) {
            App.Trakt.client.images.get({
                ...
                imdb: metadatas.type === 'movie' ? metadatas.movie.ids.imdb : metadatas.appow.ids.imdb,
                tvdb: metadatas.type === 'movie' ? false : metadatas.appow.ids.tvdb,
            ...
            App.Trakt.client.matcher.match({
                ...
                switch (metadatas.type) {
                    case 'movie':
                        ...
                        break;
                    case 'episode':
                        props.tvdb_id = metadatas.appow.ids.tvdb;
                        props.episode_id = metadatas.episode.ids.tvdb;
                        props.imdb_id = metadatas.appow.ids.imdb;
                        props.episode = metadatas.episode.number;
                        props.season = metadatas.episode.season;
                        props.title = metadatas.appow.title + ' - ' + i18n.__('Season %s', metadatas.episode.season) + ', ' + i18n.__('Episode %s', metadatas.episode.number) + ' - ' + metadatas.episode.title;
                        break;
                    default:
