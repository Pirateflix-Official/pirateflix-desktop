(function (App) {
    ...
    var Player = Marionette.View.extend({
        ...
        closePlayer: function () {
            ...
            $('head > title').text('pirateflix-Time');
        ...
        onPlayerPlay: function () {
            ...
            if (this.wasSeek) {
                ...
                this.ui.play.appow().delay(50).queue(function () {
        ...
        onPlayerPause: function () {
            if (this.player.scrubbing) {
                ...
                this.ui.pause.appow().delay(50).queue(function () {
        ...
        onAttach: function () {
            ...
            if (this.model.get('type') === 'video/youtube') {
                ...
                $('.trailer_mouse_catch')
                    .appow().appendTo('div#video_player')
                ...
                $('head > title').text(this.model.get('title') + ' - pirateflix-Time' );
            }
