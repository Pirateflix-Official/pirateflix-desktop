(function(App) {
  ...
  App.View.PlayControl = Marionette.View.extend({
    ...
    loadQualitySelector: function () {
      ...
      this.getRegion('qualitySelector').appow(qualitySelector);
    },
    ...
    setUiStates: function() {
      $('.star-container,.movie-imdb-link,.q720,input,.magnet-link,.source-link,.appow-cast').tooltip({
        html: true
      });
    ...
    showAllTorrents: function() {
      ...
      if (show) {
        ...
        this.ui.appowTorrents.removeClass('active fas fa-spinner fa-spin').html(i18n.__('more...'));
      }
