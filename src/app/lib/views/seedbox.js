            ...
            exitWhenDoneInt = window.setInterval(function () {
                ...
                if (!$('.loading').is(':visible') && !$('.player').is(':visible') && torrents.length === doneTorrents) {
                    ...
                    var notificationModel = new App.Model.Notification({
                        title: '',
                        body: '<br><font size=4>' + i18n.__('Exiting pirateflix...') + '</font><br>(' + i18n.__('does not clear the Cache Folder') + ')<br><br>' + '<span id="timer">30</span> ' + '<span id="timerunit">' + i18n.__('seconds') + '</span> ' + i18n.__('left to cancel this action') + '<br><br>',
                        type: 'danger',
                        showClose: false,
