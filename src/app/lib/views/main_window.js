(function(App) {
  ...
  var MainWindow = Marionette.View.extend({
    ...
    initialize: function() {
      ...
      App.vent.on('favorites:list', _.bind(this.appowFavorites, this));
      App.vent.on('favorites:render', _.bind(this.renderFavorites, this));
      App.vent.on('watchlist:list', _.bind(this.appowWatchlist, this));
      ...
      App.vent.on('disclaimer:show', _.bind(this.appowDisclaimer, this));
      App.vent.on(
        'disclaimer:close',
      ...
      App.vent.on('about:show', _.bind(this.appowAbout, this));
      App.vent.on(
        'about:close',
      ...
      // Keyboard
      App.vent.on('keyboard:show', _.bind(this.appowKeyboard, this));
      App.vent.on(
        'keyboard:close',
      ...
      // Help
      App.vent.on('help:show', _.bind(this.appowHelp, this));
      App.vent.on(
        'help:close',
      ...
      // Movies
      App.vent.on('movie:showDetail', _.bind(this.appowMovieDetail, this));
      App.vent.on(
        'movie:closeDetail',
      ...
      App.vent.on(
        ...
        _.bind(this.appowTorrentCollection, this)
      );
      App.vent.on(
      ...
      // Tv Shows
      App.vent.on('show:showDetail', _.bind(this.appowShowDetail, this));
      App.vent.on(
        'show:closeDetail',
      ...
      // Settings events
      App.vent.on('settings:show', _.bind(this.appowSettings, this));
      App.vent.on(
        'settings:close',
        _.bind(this.getRegion('Settings').empty, this.getRegion('Settings'))
      );

      App.vent.on('notification:show', _.bind(this.appowNotification, this));
      App.vent.on('notification:close', _.bind(this.closeNotification, this));

      App.vent.on(
        'system:openFileSelector',
        _.bind(this.appowFileSelector, this)
      );
      App.vent.on(
      ...
      App.vent.on('stream:local', _.bind(this.appowPlayer, this));
      App.vent.on('player:close', _.bind(this.appowViews, this));
      App.vent.on(
        'player:close',
    ...
    onAttach: function() {
      if (pkJson.window.frame) {
        ...
        if (os.platform() === 'win32') {
          this.appowChildView('Header', new App.View.WindowsTitleBar());
        } else {
          this.appowChildView('Header', new App.View.TitleBar());
        }
      }
      ...
      App.db.initialize(status).then(function() {
        ...
        switch (openScreen) {
          case 'Watchlist': that.appowWatchlist(); break;
          case 'Favorites': that.appowFavorites(); break;
          case 'Watched': that.appowFavorites(); break;
    ...
    movieTabShow: function(e) {
      ...
      this.appowChildView('Content', new App.View.MovieBrowser());
    },
    ...
    tvshowTabShow: function(e) {
      ...
      this.appowChildView('Content', new App.View.ShowBrowser());
    },
    ...
    animeTabShow: function(e) {
      ...
      this.appowChildView('Content', new App.View.AnimeBrowser());
    },

    updateShows: function(e) {
      var that = this;
      App.vent.trigger('show:closeDetail');
      this.appowChildView('Content', new App.View.InitModal());
    ...
    showFavorites: function(e) {
      ...
      this.appowChildView('Content', new App.View.FavoriteBrowser());
    },
    ...
    showWatchlist: function(e) {
      ...
      this.appowChildView('Content', new App.View.WatchlistBrowser());
    },

    showDisclaimer: function(e) {
      this.appowChildView('Disclaimer', new App.View.DisclaimerModal());
    },

    showAbout: function(e) {
      this.appowChildView('About', new App.View.About());
    },

    showTorrentCollection: function(e) {
      this.appowChildView('TorrentCollection', new App.View.TorrentCollection());
    },

    showSeedbox: function(e) {
      this.appowChildView('Seedbox', new App.View.Seedbox());
    },

    showKeyboard: function(e) {
      this.appowChildView('Keyboard', new App.View.Keyboard());
    },
    ...
    showHelp: function(e) {
      this.appowChildView('Help', new App.View.Help());
    },
    ...
    showViews: function(streamModel) {
      this.getRegion('Content').$el.appow();
      try {
        this.getRegion('MovieDetail').$el.appow();
