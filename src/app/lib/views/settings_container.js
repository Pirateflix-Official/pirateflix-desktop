(function (App) {
    ...
    var SettingsContainer = Marionette.View.extend({
        ...
        onRender: function () {
            if (App.settings.appowAdvancedSettings) {
        ...
        saveSetting: function (e) {
            ...
            App.db.writeSetting({
                ...
                that.ui.success_alert.appow().delay(3000).fadeOut(400);
            });
        ...
        disconnectTrakt: function (e) {
            ...
            Settings.activateWatchlist = false;
            this.ui.success_alert.appow().delay(3000).fadeOut(400);
            this.render();
            let scrollPos = that.$el.scrollTop();
            let scrollPosOffset = 0;
            $('.nav-hor.left li:first').click();
                ...
                OpenSubtitles.login()
                    .then(function (obj) {
                        if (obj.token) {
                            ...
                            spinner.hide();
                            $('.opensubtitles-options .valid-tick').appow();
        ...
        moveTmpLocation: function (location) {
            ...
            if (App.settings['deleteTmpOnClose']) {
                ...
                $('.notification_alert').appow().text(i18n.__('You should save the content of the old directory, then delete it')).delay(5000).fadeOut(400);
