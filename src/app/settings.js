/** Default settings **/
var Settings = {
  projectName: 'pirateflix',
  projectUrl: '',
  projectCi: 'https://github.com/pirateflix-official/pirateflix-desktop/actions',
  projectBlog: 'https://github.com/pirateflix-official/pirateflix-desktop/wiki',
  projectForum: 'https://www.reddit.com/r/pirateflixApp',
  projectForum2: '',
  statusUrl: 'https://status.pirateflix.app',
  changelogUrl: 'https://github.com/pirateflix-official/pirateflix-desktop/commits/master',
  issuesUrl: 'https://github.com/pirateflix-official/pirateflix-desktop/issues',
  sourceUrl: 'https://github.com/pirateflix-official/pirateflix-desktop/',
  commitUrl: 'https://github.com/pirateflix-official/pirateflix-desktop/commit',
  dht: '',
  dhtInfo: '',
  updateKey:
    '-----BEGIN PUBLIC KEY-----\n' +
...
Settings.appowSeedboxOnDlInit = true;
...
Settings.appowAdvancedSettings = true;
...
Settings.appows_default_quality = '1080p';
...
Settings.httpApiUsername = 'pirateflix';
Settings.httpApiPassword = 'pirateflix';
