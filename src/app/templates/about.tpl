<div class="about-container">
    ...
    <img class="icon-title" src="/src/app/images/pirateflix-time-logo.svg">
    <div class="content">
        ...
        <div class="text-about">
            <div class="full-text">
                ...
                <%= i18n.__("We are an open source project. We are from all over the world. We love our movies. And boy, do we love pirateflix.") %>
            </div>
        </div>
